...
const AnalysisProjects = () => {
  ...
  const analysisProjects = [
    {
      title: "Trust-in-Government Analysis",
    ...
    <div className="min-h-screen bg-blue-500">
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-pink-300 mb-4">Analysis Projects</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {analysisProjects.map((project, index) => (
            <Card key={index} className="hover:shadow-xl transition-all duration-300 group bg-amber-100 border-2 border-amber-300">
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="mb-4">
                  <h4 className="text-sm font-semibold text-green-800 mb-2">Impact:</h4>
                  <p className="text-xs text-green-700">{project.impact}</p>
                </div>
